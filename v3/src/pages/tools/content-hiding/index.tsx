...
const ContentHidingForm = loadable(() => import('../../../components/Microsites/Tools/ContentHidingForm/ContentHidingForm'), { fallback: loadableFallbackTemplate('#strong-password-form-component') });
