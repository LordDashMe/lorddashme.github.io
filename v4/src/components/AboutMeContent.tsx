  ...
  public render(): JSX.Element {
    ...
    return (
      <div className={styles.container}>
        ...
        <p>Hi, I'm Joshua Clifford "Dash" Reyes. I've been in the industry for 7 years+ and worked on several projects that contributed to the open source community, and I'm still maintaining some of those projects.</p>
